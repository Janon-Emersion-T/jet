...
AGENTS: Dict[str, AgentProfile] = {
    ...
    "codex": AgentProfile(
        ...
        objective="Plans, scaffolds, edits, and verifies modern Laravel web applications with safe file and terminal workflows.",
        route_names=["web_development", "developer_setup", "advanced_laravel", "patch", "execution", "project_context"],
        domains=["development", "project"],
        intents=["web_development", "laravel", "project_analysis", "patch_workflow"],
        keywords=[
        ...
        safety_note="Codex should plan changes carefully and never overwrite existing work without confirmation.",
    ),
