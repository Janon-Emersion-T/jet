...
from core.routes.javascript_knowledge_routes import handle_javascript_knowledge_routes
from core.routes.programming_knowledge_routes import handle_programming_knowledge_routes

from core.routes.medical_routes import handle_medical_routes
from core.routes.agent_routes import handle_agent_routes
...
ROUTE_MODULES = [
    RouteModule(
        name="agent_registry",
        domain="core",
        handler=handle_agent_routes,
        description="List and inspect Jarvis specialist agents.",
        keywords=[
            "agents",
            "list agents",
            "show agents",
    ...
    RouteModule(
        ...
        domain="development",
        handler=handle_programming_knowledge_routes,
        description="Learn and refresh programming languages, frameworks, and broader technical curriculum topics from configured sources.",
        keywords=[
        ...
        examples=[
            ...
            "learn laravel",
            "learn all 200 topics",
            "automate learning for the full curriculum",
    ...
    RouteModule(
        ...
        domain="frontend",
        handler=handle_javascript_knowledge_routes,
        description="Learn, update, explain, audit, and generate practical JavaScript knowledge.",
        keywords=[
            "javascript",
            "js",
            "ecmascript",
        ...
        canonical_commands=[
            ...
            "check javascript knowledge",
            "check js knowledge",
            "check whether you already know javascript",
        ...
        examples=[
            "teach yourself latest JavaScript",
            "learn JavaScript properly from official sources",
            "check whether you already know JavaScript",
            "what JavaScript knowledge do you have",
            "create a modern JavaScript foundation",
            "audit resources/js/app.js",
            "check whether resources/js/app.js is production ready",
            "explain JavaScript promises",
            "explain async await",
            "explain the event loop",
            "translate this JavaScript logic to React",
            "make interactive website behavior using vanilla JS",
        ],
    ),
    ...
    RouteModule(
        name="medical",
        domain="medical",
        handler=handle_medical_routes,
        description="Provide safe general medical guidance, symptom explanation, warning signs, and next-step advice.",
        keywords=[
            "medical",
            "health",
            "doctor",
        ...
        examples=[
            ...
            "I feel burning pain when walking",
            "What should I do for a wound",
    ...
    RouteModule(
        name="project_health",
        domain="development",
        handler=handle_project_health_routes,
        description="Run project health checks, code smell scans, TODO scans, and safe diagnostics.",
        keywords=[
            "project health",
            "health score",
            "code smell",
        ...
        intents=["project_analysis", "development", "command"],
        canonical_commands=[
            "project health score",
            "project todo scanner",
            "code smell detector",
            "dead file detector",
            "missing view detector",
            ...
            "php syntax checker",
            "js syntax checker",
            "css tailwind checker",
            "blade syntax risk checker",
            "vite build checker",
            "npm script runner",
        ...
        examples=[
            ...
            "give me the project health score",
            "scan the project for TODOs",
