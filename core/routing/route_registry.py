...
ROUTE_MODULES = [
    RouteModule(
        ...
        keywords=[
            "html", "doctype", "tag", "element", "semantic", "accessibility",
            "form", "meta", "head", "body", "section", "article", "landing page",
            "website structure", "web page", "frontend markup"
        ],
        intents=[
            "html_knowledge", "frontend_html", "learn_html", "audit_html",
            "generate_html", "explain_html"
        ],
        canonical_commands=[
    ...
    RouteModule(
        ...
        keywords=["task", "todo", "remind", "schedule"],
        intents=["task"],
    ),
