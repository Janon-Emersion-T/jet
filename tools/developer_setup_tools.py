...
from tools.laravel_content_platform_templates import (
    build_laravel_content_platform_files,
    patch_bootstrap_for_admin,
)
...
def _scaffold_laravel_content_platform(project_dir: Path, company_name: str) -> list[str]:
    files = build_laravel_content_platform_files(company_name)
    for relative_path, content in files.items():
        _write_text(project_dir / relative_path, content)

    patch_bootstrap_for_admin(project_dir)
